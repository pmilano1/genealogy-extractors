...
Usage:
    ...
    python3 research_runner.py --limit 10

    # Search specific source only
    python3 research_runner.py --source geneanet --limit 10

    # Search all sources, no limit (full database scan)
    python3 research_runner.py --all

    # Review staged findings interactively
    python3 research_runner.py --review

    # Show summary of staged findings
    python3 research_runner.py --summary

    # Submit approved findings to API
    python3 research_runner.py --submit-approved
"""
...
from api_client import get_all_people_iterator, person_to_search_params, submit_research
from staged_findings import StagedFindings
